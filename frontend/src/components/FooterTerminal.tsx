  ...
  return (
    <>
      <footer
        ...
        className={`bg-black/95 backdrop-blur-md border-t border-terminal-green/40 h-44 md:h-52 p-4 font-mono text-xs md:text-sm overflow-hidden flex flex-col cursor-text fixed bottom-0 left-0 w-full z-40 shadow-[0_-10px_30px_rgba(0,0,0,0.8)] transition-transform duration-300 ease-out ${
          ...
          <div className="text-terminal-green/50 flex justify-between items-center border-b border-terminal-green/30 pb-2 mb-3 shrink-0">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="text-terminal-green/70 hover:text-terminal-green hover:bg-terminal-green/20 px-2 py-1 rounded transition-colors flex items-center gap-1 group border border-transparent hover:border-terminal-green/30"
                title="Скрыть терминал"
              >
                <span className="group-hover:animate-pulse font-bold">_</span>{" "}
                MINIMIZE
              </button>
            </div>
          </div>
